<template>
  <VueEnhancedSwiper
    ...
    :scroll-conflict="{
      ...
      debug: true,
      swipeDistance: {
        withScroll: swipeSettings.withScroll,
        withoutScroll: swipeSettings.withoutScroll
      }
    }"
    class="demo-swiper"
          ...
          <div class="settings-content">
            <div class="setting-section">
              ...
              <div class="setting-item">
                ...
                <div class="setting-control">
                  <input type="range" min="1" max="50" v-model="tolerance">
            ...
            <div class="setting-section">
              ...
              <div class="setting-item">
                <label>有滚动内容时</label>
                <div class="setting-control">
                  <input type="range" min="20" max="150" v-model="swipeSettings.withScroll">
                  <span>{{ swipeSettings.withScroll }}px</span>
                </div>
              </div>
              ...
              <div class="setting-item">
                <label>无滚动内容时</label>
                <div class="setting-control">
                  <input type="range" min="10" max="100" v-model="swipeSettings.withoutScroll">
                  <span>{{ swipeSettings.withoutScroll }}px</span>
                </div>
              </div>
              ...
              <div class="setting-item">
                <label>重置为默认值</label>
                <div class="setting-control">
                  <button class="reset-btn" @click="resetSwipeSettings">🔄 重置</button>
                </div>
              </div>
            </div>
            ...
            <div class="setting-section">
              ...
              <div class="instructions">
                ...
                <div class="instruction-item">
                  <span class="instruction-icon">🔧</span>
                  <p><strong>简化逻辑:</strong> 只检测是否有滚动元素，到达边界时执行切换</p>
                </div>
                
                <div class="instruction-item">
                  <span class="instruction-icon">📏</span>
                  <p><strong>滑动距离:</strong> 可调节触发页面切换需要的滑动距离，有滚动内容默认{{ swipeSettings.withScroll }}px，无滚动内容默认{{ swipeSettings.withoutScroll }}px</p>
                </div>
              </div>
            </div>
          </div>
...
import { VueEnhancedSwiper, SwiperSlide } from '../src/index'
...
// 滑动距离设置
const swipeSettings = ref({
  withScroll: 50,    // 有滚动内容时的滑动距离
  withoutScroll: 30  // 无滚动内容时的滑动距离
})
